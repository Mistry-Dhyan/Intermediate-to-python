...
best_animals = animals[:3]

##The most inportat diffrences bettween strings and lists that in strings you can't add more strings in it but you can in a list.
##mutabitlity is something that is changing.
